   ...
   const handleInputChange = (e)=>{
    ...
    return(
      <div>
        ...
        {isFormVisible ? 'Hide from': 'show form'}
        ...
        {isFormVisible && (
              ...
              <div className="mb-6">
              <label className=" tracking-wide text-gray-900  font-semibold mb-4" for="parents phone">
              Parent's Phone No
              </label>
              <input 
              className="mt-4 shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" 
              ...
              <div className="mt-4 relative border border-gray-300 text-gray-800 bg-white shadow-lg">
              ...
              onChange={handleInputChange}
              className="appearance-none text-gray-900 font-semibold w-full py-1 px-2 bg-white" name="courseLeve" id="courseLeve">
              <option > course level &hellip;</option>
              ...
              onChange={handleInputChange}
              className="appearance-none text-gray-900 font-semibold w-full py-1 px-2 bg-white" name="course" id="course">
